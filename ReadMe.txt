1. Import the project on Eclipse or other IDE.
2. Use JDK 1.8 version.
3. Build the project locally.
4. Deploy the project locally.
5. Open the browser.
6. Hit the URL 
	http://localhost:8090/crawl/extent/2?uri=https://www.prudential.co.uk/
7. Enter any URL as query paramter to crawl.
8. Modify the extent variable value to see the number of records.
